 ...
 * 
 */
@WebServiceClient(name = "UserServiceService", targetNamespace = "http://service.com/", wsdlLocation = "http://localhost:8080/LibraryManagementSystemWS/UserServiceService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICESERVICE_QNAME = new QName("http://service.com/", "UserServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/LibraryManagementSystemWS/UserServiceService?WSDL");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("http://service.com/", "UserServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.com/", "UserServicePort"), UserService.class, features);
    }
