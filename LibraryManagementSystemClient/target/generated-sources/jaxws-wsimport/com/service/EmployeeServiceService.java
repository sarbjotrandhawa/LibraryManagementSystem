 ...
 * 
 */
@WebServiceClient(name = "EmployeeServiceService", targetNamespace = "http://service.com/", wsdlLocation = "http://localhost:8080/LibraryManagementSystemWS/EmployeeServiceService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICESERVICE_QNAME = new QName("http://service.com/", "EmployeeServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/LibraryManagementSystemWS/EmployeeServiceService?WSDL");
    ...
    public EmployeeService getEmployeeServicePort() {
        return super.getPort(new QName("http://service.com/", "EmployeeServicePort"), EmployeeService.class);
    }
    ...
    public EmployeeService getEmployeeServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.com/", "EmployeeServicePort"), EmployeeService.class, features);
    }
